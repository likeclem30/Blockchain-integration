	...
	b.prototype= {
		...
		backdrop:function(b) {
			...
			if(this.isShown&&this.options.backdrop) {
				...
				this.$backdrop.click(this.options.backdrop=="static"?a.proxy(this.$element[0].focus, this.$element[0]): a.proxy(this.hide, this)), e&&this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in");
				if(!b)return;
...
!function(a) {
	...
	c.prototype= {
		...
		toggle:function(b) {
			...
			g=f.hasClass("open"),
			d(),
			g||("ontouchstart"in document.documentElement&&a('<div class="dropdown-backdrop"/>').insertBefore(a(this)).on("click", d), f.toggleClass("open")),
			c.focus(),
			!1
		}
		,
	...
	b.prototype= {
		...
		activate:function(b, c, d) {
			function g() {
				...
				b.addClass("active"),
				f?(b[0].offsetWidth, b.addClass("in")): b.removeClass("fade"), b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active"), d&&d()
			}
			var e=c.find("> .active"),
...
!function(a) {
	...
	b.prototype= {
		...
		applyPlacement:function(a, b) {
			...
			b=="bottom"||b=="top"?(h=0, a.left<0&&(h=a.left*-2, a.left=0, c.offset(a), f=c[0].offsetWidth, g=c[0].offsetHeight), this.replaceArrow(h-d+f, f, "left")): this.replaceArrow(g-e, g, "top"), i&&c.offset(a)
		}
		,
...
!function(a) {
	...
	b.prototype.checkPosition=function() {
		...
		this.affixed=i,
		this.unpin=i=="bottom"?d.top-c: null, this.$element.removeClass(h).addClass("affix"+(i?"-"+i:""))
	}
	;
	var c=a.fn.affix;
...
!function(a) {
	...
	b.prototype= {
		...
		reset:function(a) {
			...
			this.$element[a!==null?"addClass": "removeClass"]("collapse"), this
		}
		,
	...
	a.fn.collapse=function(c) {
		return this.each(function() {
			var d=a(this), e=d.data("collapse"), f=a.extend( {}
...
!function(a) {
	...
	a.fn.carousel=function(c) {
		return this.each(function() {
			var d=a(this), e=d.data("carousel"), f=a.extend( {}
			, a.fn.carousel.defaults, typeof c=="object"&&c), g=typeof c=="string"?c: f.slide;

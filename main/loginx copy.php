...
<script src="http://192.168.64.2/logsignup/assets/jquery.min.js"></script>
    <script src="http://192.168.64.2/logsignup/assets/js/bootstrap.min.js"></script> 
    <script src="http://192.168.64.2/logsignup/assets/parsley.min.js"></script>
    <script src="http://192.168.64.2/logsignup/assets/modal.js"></script> 


    
<script type="text/javascript" src="http://192.168.64.2/logsignup/js/validator.min.js"></script>
<script type="text/javascript" src="http://192.168.64.2/logsignup/js/form-scripts.js"></script>

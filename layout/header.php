      ...
      <nav class="navbar navbar-static-top">
        <div class="container-fluid">
          <div class="navbar-header">
            <a href="<?php echo $sitename.'application/main/navigation.php';?>" class="navbar-brand">
           <!--  <a href="<?php echo $sitename.'application/main/index.php';?>" class="navbar-brand">  -->
             <span class="logo-mini"> 
              <b>Agrikore-</b>BlockChain
            </span>
          </a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            foreach($key as $menu) 
            {
             ...
             // $jumlah_submenu = count($query_sub_menu[2]); 
            ...
            if($cekmenuz >0)
            {
              ...
              <li class="dropdown"><a  href="#" class="dropdown-toggle" data-toggle="dropdown">
                <?php echo $menu['name_menu']; ?> <span class="caret"></span></a>
                <?php 
              }

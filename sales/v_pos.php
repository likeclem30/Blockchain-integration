...
<section class="content">
	<div class="row">
		<div class="col-md-8">
		<h3 class="bordercool">Grant Disbursement</h3>
			<div class="box box-success">
				<div class="box-header with-border">
				<button type="submit" class="btn btn-primary " id="btnadd" name=""><i class="fa fa-plus"></i> Add Item</button>
				<button type="submit" class="btn btn-primary " id="btnadd" name=""><i class="fa fa-plus"></i> Request to Buy</button>
				...
				<button type="submit" class="btn btn-primary " id="btnadd" name=""><i class="fa fa-plus"></i> Produce Receipt</button>
					<h3 class="bordercool">Beneficiaries Transaction</h3>
			...
			<div class="box box-danger">
				...
				<div class="box-body">
					<div class="form-horizontal">
						...
						<div class="form-group">  
							<label class="col-sm-3  control-label"><a href="#" class="btndisc btndiscrp">Dsc N</a></label>  
							<div class="col-sm-9">
								<div class="input-group">
				...
				<div class="info-box" style="margin-top:15px;">
					<span class="info-box-icon bg-yellow">N.</span>
